...
SEI_pII_hRD_fun<- function(current_timepoint, state_values, parameters)
{
  ...
  with(
    as.list(parameters), #variable names within parameters can be used
    {
      ...
      dI_h <- sigma_ih*I_p +phi_i*I - gamma_ih*I_h- delta_ih*I_h
...
incubation_period=3#5-6 days (max 14 days)
presymptomatic_infectious_period=2#1-3 days
infectious_period=7 #
isolation_stay= 10#7-16
...
plot(output_SEI_pII_hRD$time,output_SEI_pII_hRD$I,
     #ylim = c(0,4e+06),
     type="n",
     xlab='Time in days',
...
lines(output_SEI_pII_hRD$time,output_SEI_pII_hRD$I_p,lwd=2.5,col='darksalmon')
